...
function preload(){
//Player
PlayerDown=loadAnimation("WalkDown1.png", "WalkDown2.png", "WalkDown3.png", "WalkDown4.png")
PlayerUp=loadAnimation("WalkUp1.png", "WalkUp2.png", "WalkUp3.png", "WalkUp4.png")
PlayerLeft=loadAnimation("WalkLeft1.png", "WalkLeft2.png")
PlayerRight=loadAnimation("WalkRight1.png", "WalkRight2.png")
PlayerFallImg=loadImage("PlayerFall.png")
PlayerFall=loadImage("Healed4.png")

//Music
wolves=loadSound("WolvesSiamese.mp3")

//Fonts
Chiller=loadFont("CHILLER.TTF")
pressStart=loadFont("Ps2p.ttf")
VerminVibes=loadFont("VerminVibes.ttf")

//Images
heart=loadImage("Heart.png")
img=loadImage("mainmenuimg.jpg")
//Loading Screen
LoadScreen=loadAnimation("LoadScreen1.png", "LoadScreen2.png")
LoadingImage=loadImage("LoadScreen1.png")
//Triggers
TriggerAImg=loadImage("TriggerA.png")
TriggerBImg=loadImage("TriggerB.png")

Heal=loadSound("Heal.wav")
TitleSplash=loadSound("TitleSplash.wav")

Begining=loadSound("begining.wav")
DontGiveUp=loadSound("DontGiveUp.wav")
NewWorld=loadSound("NewWorld.wav")
}
